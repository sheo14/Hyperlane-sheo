...
export const APP_NAME = 'SHEO BRIDGE ';
export const APP_DESCRIPTION = 'Fast bridge powered by hyperlane, welcome to SHEO bridge';
export const APP_URL = 'sheo-bridge.vercel.app';
